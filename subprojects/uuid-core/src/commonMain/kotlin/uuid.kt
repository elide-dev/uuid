 ...
 */
@JvmInline
public expect value class Uuid @SinceKotlin("2.0") public constructor (
 ...
 *
 * Version 4 UUIDs are randomly generated from the best available random source. The selection of that source depends on
 * the platform. Some systems may be bad at generating sufficient entropy, e.g. virtual machines, and this might lead to
 * collisions faster than desired. Version 5 may be used if this is the case and no other measures are possible to
 * increase the entropy of the random source used by the platform.
 *
 ...
 *
 * Version 3 and 5 UUIDs are created by combining a name and a namespace using a hash function. This library may provide
 * such hash functions in the future, but it adds a significant maintenance burden to support for native, JS, and JVM.
 *
 * Until then:
