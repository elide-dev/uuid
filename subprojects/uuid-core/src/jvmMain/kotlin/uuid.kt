 ...
 */
@JvmInline
public actual value class Uuid public actual constructor (public val pair: Pair<Long, Long>):
  Comparable<Uuid>,
  JSerializable {
  ...
  public val javaUuid: JavaUUID get() = JavaUUID(mostSignificantBits, leastSignificantBits)
